...
def main(_):
  ...
  train_writer = tf.summary.FileWriter(log_dir + '/'+'AdamNC')
  print(log_dir)
  ...
  for epoch in range(training_epochs+1):
    ...
    lr, b2, summary, loss, _, _, _, _= sess.run([learning_rate, beta2, merged, cross_entropy, train_step, add_global, add_f_old, add_f_new], feed_dict={x: batch_xs, y_: batch_ys})
    # print(lr, b2)
