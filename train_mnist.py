...
class Solver(object):
    def __init__(self, config):
        ...
        test_id = 'mnist' + '_' + self.optimizer_name
    ...
    def load_model(self):
        ...
        if self.optimizer_name == 'adam':
            ...
            self.optimizer = NosAdam(self.model.parameters(), lr=self.lr, gamma=0.01)
    ...
    def save(self):
        model_out_path = 'mnist'+self.optimizer_name+"model.pth"
